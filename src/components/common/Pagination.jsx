  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 border-t border-gray-200">
      <p className="text-xs text-gray-500">
        ...
        <span className="font-medium">{total}</span> policies
      </p>
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          disabled={page === 1}
          className="px-2.5 py-1.5 text-xs rounded-lg border border-gray-300 text-gray-600
        ...
        {getPages().map((p, i) =>
          p === '...' ? (
            ...
            <button
              ...
              className={`
                w-8 h-8 text-xs rounded-lg border transition
                ${p === page
